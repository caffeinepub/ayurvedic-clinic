...
export class Backend implements backendInterface {
    ...
    async getAddress(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getAddress();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getClinicName(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getClinicName();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPhone(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getPhone();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getServices(): Promise<Array<string>> {
        if (this.processError) {
            try {
